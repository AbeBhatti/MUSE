...
echo "🔧 Fixing CloudFront stems policy..."
echo ""
...
# Create a new cache behavior for /stems/*
...
# Add the new behavior to the config
UPDATED_CONFIG=$(echo "$CONFIG" | jq ".CacheBehaviors.Items += [$NEW_BEHAVIOR]")
